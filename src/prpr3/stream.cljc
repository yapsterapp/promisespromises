(ns prpr3.stream
  ...
  "asynchronous stream operations - public API

   links to fns in [[prpr3.stream.transport]],
   [[prpr3.stream.operations]] and [[prpr3.stream.cross-impl]]"
